...
import { listHeader, listProjects } from "./assets/projects";
    ...
    <motion.div id="main" className="pt-44 font-urbanist">
      ...
      >
        ...
        <div className="flex gap-10 flex-col justify-center items-center">
          <h1
            ref={containerRef}
            className="text-center md:w-[60%] w-[70%] text-5xl mx-20 md:text-6xl lg:text-7xl font-medium font-urbanist"
          >
            {"Devenez irrésistible sur votre marché et signez vos"
              .split(" ")
              .map((word, index) => (
        ...
        <div
          ...
          className="h-[40vw] masked-text mt-40 overflow-x-hidden flex"
        >
          <div className="overflow-hidden select-none border-dashed  border-y border-current text-sm py-2 flex gap-[20px]">
            ...
            <div className="list-none flex-shrink-0 min-w-full flex justify-between items-center gap-[20px] animate-scroll">
              {listHeader.map((item) => (
                <img className="h-full" src={item} alt="Image 1" />
              ))}
            </div>
            <div className="list-none flex-shrink-0 min-w-full flex justify-between items-center gap-[20px] animate-scroll">
              {listHeader.map((item) => (
